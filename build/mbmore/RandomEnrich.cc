#line 1 "/Users/mbmcgarry/git/mbmore/src/RandomEnrich.cc"
...
#line 246 "/Users/mbmcgarry/git/mbmore/src/RandomEnrich.cc"
...
void RandomEnrich::AddMat_(cyclus::Material::Ptr mat) {
  ...
  if (extra_u) {
    cyclus::Warn<cyclus::VALUE_WARNING> ("More than 2 isotopes of U.  "        "Istopes other than U-235, U-238 are sent directly to tails.");
#line 354 "/Users/mbmcgarry/git/mbmore/src/RandomEnrich.cc"
  }
  if (other_elem) {
    cyclus::Warn<cyclus::VALUE_WARNING> ("Non-uranium elements are "         "sent directly to tails.");
#line 358 "/Users/mbmcgarry/git/mbmore/src/RandomEnrich.cc"
  }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Material::Ptr RandomEnrich::Enrich_(
