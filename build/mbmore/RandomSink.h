...
#line 1 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
...
#line 36 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"

  virtual void InitFrom(mbmore::RandomSink* m);
...
#line 38 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
...
#line 123 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  std::vector<std::string> in_commods;

  // if using a single recipe
  #pragma cyclus var {"default": "", "tooltip": "requested composition",                            "doc": "name of recipe to use for material requests, "                              "where the default (empty string) is to accept "                              "everything",                        "uilabel": "Input Recipe",                       "uitype": "recipe"}
#line 132 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  std::string recipe_name;

  // if using multiple recipes
  #pragma cyclus var {"default": [],"uitype": ["oneormore", "recipe"],     "uilabel": "Input Recipe List",     "doc": "Input recipes to request for different timesteps "             "(randomly chosen)",   }
#line 140 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  std::vector<std::string> recipe_names;
  
  //***
  #pragma cyclus var {"default": "None", "tooltip": "social behavior",	                          "doc": "type of social behavior used in trade "                                  "decisions: None, Every, Random, Reference "                                  "where behav_interval describes the "                                  "time interval for behavior action."                                  "Reference queries the RNG to mimic Random, "                                 "but returns zero material qty to trade."}
#line 150 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
...
#line 156 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double behav_interval;

  #pragma cyclus var {"default": 1, "tooltip": "user-defined preference" ,                       "doc": "change the default preference for requests "                             "from this agent"}
#line 161 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  int user_pref;

  #pragma cyclus var {"default": 0, "tooltip": "defines RNG seed",                        "doc": "seed on current system time if set to -1,"                                " otherwise seed on number defined"}
#line 166 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  int rng_seed;

  #pragma cyclus var {"default": 1e299, "tooltip": "sink avg_qty",	                          "doc": "mean for the normal distribution that "                                  "is sampled to determine the amount of "                                  "material actually requested at each "                                  "time step"}
#line 173 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double avg_qty;

  #pragma cyclus var {"default": 0, "tooltip": "standard deviation",	                          "doc": "standard deviation (FWHM) of the normal "                                  "distribution used to generate requested "                                  "amount of material (avg_qty)" }
#line 179 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double sigma; 

  #pragma cyclus var {"default": 0,					                      "tooltip": "time to being allowing trades",                          "doc": "At all timesteps before this value, the "                                    "facility does make material requests. At "                                  "times at or beyond this value, requests are "                                 "made subject to the other behavioral "                                  "features available in this archetype"  }
#line 188 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double t_trade;   //*** 

  /// max inventory size
  #pragma cyclus var {"default": 1e299,                       "tooltip": "sink maximum inventory size",                       "uilabel": "Maximum Inventory",                       "doc": "total maximum inventory size of sink facility"}
#line 195 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double max_inv_size;

  /// monthly acceptance capacity
  #pragma cyclus var {"default": 1e299, "tooltip": "sink capacity",                       "uilabel": "Maximum Throughput",                       "doc": "capacity the sink facility can "                              "accept at each time step"}
#line 202 "/Users/mbmcgarry/git/mbmore/src/RandomSink.h"
  double capacity;
