...
TEST_F(CascadeEnrichTest, RequestQty) {
  ...
  cyclus::MockSim sim(cyclus::AgentSpec
		      (":mbmore:CascadeEnrich"), config, simdur);
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(CascadeEnrich, CheckCapConstraint) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void CascadeEnrichTest::TearDown() {
  delete src_facility;
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Material::Ptr
CascadeEnrichTest::DoOffer(cyclus::Material::Ptr mat) {
  return src_facility->Offer_(mat);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Material::Ptr
CascadeEnrichTest::DoEnrich(cyclus::Material::Ptr mat, double qty) {
